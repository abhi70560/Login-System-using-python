...
class Login:
    def __init__(self, root):
        ...
        # Background Image
        self.bg = ImageTk.PhotoImage(file="python/55621.jpg")
        ...
        subtitle = Label(Frame_login, text="Members Login Area", font=("Goudy old style", 15, "bold"), fg="#1d1d1d", bg="white").place(x=90, y=70)
